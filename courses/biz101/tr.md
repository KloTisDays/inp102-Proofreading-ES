...
## Şirketinizi Bitcoin'e dahil edin

<chapterId>1be42be9-4080-49f5-b5b2-6b531dd55f5f</chapterId>

Bitcoin ve Lightning Network'nin geleneksel iş operasyonlarında nasıl devrim yaratabileceğini anlamak için bir geçit olan bu kapsamlı eğitim kursu ile şirketinizin Bitcoin ağındaki yolculuğuna başlayın. Bu eğitim, küresel, internete özgü bir parasal ağ ve Exchange'ün sağlam bir değer aracı olarak Bitcoin'ün pratik yeteneklerini keşfetmek isteyen perakendeciler, girişimciler, yöneticiler ve kurumsal karar vericiler için tasarlanmıştır.

Kurs boyunca, Bitcoin ve Lightning Network'i belirgin bir şekilde dönüştürücü kılan temel ilkelerle tanışacaksınız. Bu teknolojilerin dijital sermaye depolamadan hızlı, ekonomik ve ölçeklenebilir ödemelere kadar bir dizi kullanım alanı sunduğunu ve geleneksel para birimi ve ödeme sistemlerine göre nasıl kritik iyileştirmeler sağladığını öğreneceksiniz. BIZ101 kursu, ekonomi teorisini gerçek dünya uygulamalarıyla birleştirerek merkezsizleşmenin aracılara olan bağımlılıkları nasıl azaltabileceğini ve eski sistemlerin doğasında bulunan sınırlamaların üstesinden nasıl gelebileceğini açıklığa kavuşturuyor.

Kurs, geleneksel para birimleri ve ödeme mekanizmalarının ayrıntılı bir incelemesiyle başlayacak ve para biriminin ticaret, tasarruf ve ekonomik uzmanlaşmayı sağlamak için bir ağ olarak nasıl işlev gördüğünü keşfederek zemin hazırlayacaktır. Daha sonra, Bitcoin'in arkasındaki teknolojiyi ve Lightning Network tarafından getirilen yenilikleri inceleyerek, bunların her büyüklükteki işletmeye hizmet edebilecek kesintisiz, güvenli ve neredeyse anlık işlemleri kolaylaştırmadaki rollerini ortaya koyacağız. Daha sonra, bitcoinleri hazine olarak tutma bölümünden başlayarak bu kursun pratik bölümlerine dalacağız ve ardından Bitcoin'i bir ödeme aracı olarak kabul etme üzerine bir son bölüm izleyeceğiz.

İster küçük bir işletmeyi ister büyük bir şirketi temsil ediyor olun, bu kurs sizi Bitcoin'u günlük operasyonlarınıza entegre edecek bilgilerle donatmayı ve böylece şirketinizin dayanıklılığını, verimliliğini ve rekabet gücünü artırmayı amaçlamaktadır. Bitcoin ekonomik manzarayı yeniden şekillendirmeye devam ederken, bu çığır açan teknolojileri anlamak sadece bir seçenek değil, stratejik bir gerekliliktir. Bitcoin'un gelişen dünyasında gezinmenizi ve bu dünyadan yararlanmanızı sağlayacak anlayışlı içerik, pratik örnekler ve stratejik rehberlik ile etkileşim kurmaya hazırlanın!
...
- İzinsiz**: Geçmişte altın ve gümüş sikkeler gibi para birimleri genellikle özel şahıslar, yerel yetkililer veya hammaddeye erişimi olan tüccarlar tarafından basılırdı. Bu sistem bazen krallar ya da yöneticiler tarafından verilen anlaşmalar ya da lisanslar çerçevesinde işliyordu. Zamanla krallar ve hükümetler ekonomik istikrar, vergilendirme ve parasal sistem üzerinde daha fazla kontrol sahibi olmak için bu süreci merkezileştirdiler. Ünlü bir örnek, ilk kez 1518 yılında **Joachimsthal Vadisi'nde** (günümüzde Çek Cumhuriyeti'nde Jáchymov) yerel madenciler ve yetkililer tarafından basılan bir gümüş para olan **thaler**dir. "Thaler" ismi Almanca "vadi" anlamına gelen **"Thal "** kelimesinden türemiştir Yüksek kaliteli gümüşleriyle bilinen bu sikkeler Avrupa çapında yaygın olarak dolaşıma girmiştir. Zamanla bu terim dilsel ve coğrafi olarak evrim geçirmiş ve nihayetinde Amerika Birleşik Devletleri'nde para birimi olarak benimsenen "dolar" adını almıştır.

Modern çağda, para birimleri senyoraj sistemi altında tamamen izinli hale gelmiştir, yani yalnızca merkez bankaları veya hazineler gibi yetkili kuruluşlar madeni para basabilir veya banknot basabilir. Bireylerin para birimi üretmesine artık yasal olarak izin verilmemekte, böylece para biriminin ihracı ve Supply üzerinde merkezi kontrol sağlanmaktadır.
...
- B2B (İşletmeden İşletmeye):**
    ...
    - Kart kullanımı mevcuttur ancak daha yüksek ücretler ve işlem limitleri nedeniyle daha az yaygın olma eğilimindedir. Alacak/verecek hesap süreçlerini kolaylaştırmak ve otomatikleştirmek için entegre ödeme platformları gibi dijital çözümler ortaya çıkmaktadır.
...
| Ödeme Yöntemi | Yetkilendirme Gerekli mi?           | İşlem Onay Süresi (Satıcı Görünümü) | Ödeme Hızı (Fonlar Tamamen Yerleşti) | Kesinlik (Geri Alma Kolaylığı) | Aracı Sayısı | Tipik Ücretler (Alacaklıya) |

| ------------------------------ | ------------------------------- | ----------------------------------------- | ---------------------------------------------- | ---------------------------------------- | ------------------------------ | ---------------------------------- |

| **Nakit** | Hayır | Anında (Fiziksel Exchange) | Anında (Uzlaştırma Gecikmesi Yok) | Yüksek (Ödendikten Sonra Geri Dönülemez) | Yok | Yok |

| **Çek** | Evet (Banka Takası) | Mevduatta Kabul (Garantili Değil) | Birkaç Gün (Çek Takas Süreci) | Orta (Takastan Önce Karşılıksız Çıkabilir/Durabilir) | Banka | **Düşük ila Orta** (Banka Ücretleri) |

| **Havale Transferleri** | Evet (Banka/Ağ) | Saatler İçinde Onay | Aynı Gün veya Sonraki Gün (Yurtiçi) | Yüksek (Genellikle Gönderildikten Sonra Geri Alınamaz) | Bankalar, Ödeme Ağları | **Orta**(Sabit/Yüzde) |

| **Ödeme Kartları** | Evet (Kart Çıkaran Kuruluş Yetkilendirmesi) | Saniyeler ila Dakikalar (Yetkilendirme Kodu) | Birkaç Gün (Bankalararası Mutabakat) | Orta (Ters İbraz Mümkün) | Çıkaran Kuruluş, Acquirer, Kart Ağı | **Değişken (İşlemin %1-3'ü)** |

| **Dijital Cüzdanlar/Mobil Ödeme** | Evet (Wallet Sağlayıcı/Banka) | Saniyeler (Anında Onay) | Genellikle 1-2 Gün (Finansman Kaynağına Bağlı) | Orta (İade/İhtilaf Mümkün) | Bankalar, Wallet Operatörleri | **Düşük ila Orta (Değişir)** | |
...
| Sınırlama | Açıklama | Etki |

| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |

| Yüksek Kart Ücretleri | Değişim ücretleri (~%0,3), ağ ücretleri (sabit veya %0,3-%1), terminal/PSP abonelikleri ve banka marjları (%0,5-%1,7), üretken sektörler üzerinde küresel bir "vergi" gibi trilyonlarca dolara ulaşan önemli bir maliyet oluşturmaktadır.     | Satıcı maliyetlerini artırarak marjları düşürür ve potansiyel olarak tüketici fiyatlarını yükseltir.                  |

| Çok Yavaş Nihai Mutabakat | Fonların mutabakatı 5 güne kadar sürebilir, bu da para akışını ve genel ekonomik faaliyeti yavaşlatır.                                                                                                                                | Tüccarlar için likiditeyi geciktirir ve ekonomik dolaşımın hızını azaltır.                        |

| Dolandırıcılık | E-ticaret kanalları dolandırıcılık tarafından yoğun bir şekilde hedef alınmakta ve önemli kayıplara (örneğin 28 milyar $) neden olmaktadır. Ters ibrazlar 2024 yılına kadar küresel olarak ~174 milyar dolara ulaşabilir. Bu anlaşmazlıkları yönetmek zaman kaybettiriyor ve zihinsel yorgunluğa neden oluyor. | Artan operasyonel maliyetler, karmaşık dolandırıcılık önleme tedbirleri ve azalan müşteri güveni.       |

| Sepeti Terk Etme | Ek güvenlik adımları (tek kullanımlık kodlar, PSD2 kapsamında iki faktörlü kimlik doğrulama) ödeme sırasında sürtünme yaratır.                                                                                                                   | Daha yüksek ödeme karmaşıklığı, sepetin terk edilmesinin artmasına ve satış kaybına neden olur.                       |

| Yüksek Asgari İşlem Tutarları Kartlardaki asgari harcama eşikleri, işyerlerini ve tüketicileri uygunsuz fiyatlandırma veya satın alma koşullarına zorlayarak küçük değerli işlemleri caydırabilir.                                                                       | Müşteri memnuniyetini ve esnekliğini azaltarak potansiyel olarak anlık veya düşük değerli satın alımları sınırlandırır.  |

| Yavaş Ön Yetkilendirme | Mevcut sistemler işlemleri milisaniye hızlarında gerçekleştiremiyor veya sürekli, gerçek zamanlı ödeme akışlarını destekleyemiyor.                                                                                                                   | Anlık veya akışlı ödeme gerektiren kullanım durumlarını sınırlandırarak inovasyonu ve ölçeklenebilirliği kısıtlar. |

| Banka/Kart Hesabı Gerekliliği | Bu ödeme yöntemlerine erişim, bağlantılı bir banka veya kart hesabı gerektirmekte ve bu tür hesapları olmayanları otomatik olarak dışlamaktadır.                                                                                                       | Finansal katılımı sınırlandırır, bankasız veya yetersiz bankalı nüfusun erişimini azaltır.                 |

| Tekrarlanan Çevrimiçi Hesap Oluşturma | Kullanıcıların genellikle birden fazla çevrimiçi hesap oluşturması gerekir, bu da yorgunluğa, rahatlığın azalmasına ve kişisel verilerin daha fazla açığa çıkmasına neden olur.                                                                                                | Kullanıcı deneyimini kötüleştirir, gizlilik endişelerini artırır ve veri ihlali riskini yükseltir.          |

| Yabancı Para Birimi (FX) Ücretleri | Evrensel bir hesap biriminin olmaması, sınır ötesi işlemler için maliyetli para birimi dönüşümlerini zorunlu kılar.                                                                                                                              | Uluslararası ticaret için ekstra maliyetler ekleyerek küresel işlemleri daha az ekonomik hale getirir.             |
...
- İnternette Exchange değerini aracılar olmadan, izin gerektirmeden ve takma adla kolaylaştıran bir bilgisayar protokolü**. Gelişmiş kriptografik prensipler kullanır.
...
Bunlar birlikte Bitcoin'i bir **taşıyıcı varlık** ve **ihraççısı olmayan** bir dijital para birimi haline getirir. Ownership yalnızca **özel kriptografik anahtarın** tutulmasıyla güvence altına alınır ve **aracılar veya güvenilir üçüncü taraflar olmadan** tam kontrol sağlar. Transfer edildiğinde, Ownership **finality** anında gerçekleşir: yeni sahibi, koruma veya dönüştürülebilirlik için merkezi bir otoriteye güvenmeden tamamen sahip olur. İşlemler **değiştirilemez** - Blockchain'a kaydedildikten sonra değiştirilemez veya silinemezler.
...
Teknik özellikleri altın ve doların toplamını aşarak onu şimdiye kadar yaratılmış en zor finansal varlık haline getirmektedir. Bitcoin hem bir değer saklama aracı hem de Exchange'ün bir aracıdır, yapım aşamasında bir para birimidir. Bir şirketin hazinesinden diğerine hızlı bir şekilde, aracılar olmadan, minimum maliyetle, sahtekarlık olmadan, 7/24 ve herhangi bir üçüncü taraf dahil olmadan değer aktardığınızı hayal edin.
...
Bitcoin, tarihi, nasıl çalıştığı ve kullanımı hakkında daha fazla bilgi için bu diğer kapsamlı kursu da takip etmenizi öneririm:
...
Lightning Network, Bitcoin'in ana Blockchain ile minimum etkileşimle Bitcoin işlemlerini kolaylaştıran bir **protokol ve ağdır**. İşte nasıl çalıştığı:
...
- off-chain işlemleri:** İşlemler taraflar arasında gerçekleşir ancak Bitcoin'nin ana Blockchain'inde (**"off-chain"**) **hemen yayınlanmaz**.
- On-Chain ödemeleri:** Bir kanalın işlemlerinin yalnızca **son bakiyesi** Bitcoin ana Blockchain'te (**"On-Chain**") yayınlanır ve bu arada çok sayıda işlemin gerçekleşmesine izin verilir. Birden fazla ödemenin bu şekilde bir araya getirilmesi tıkanıklığı azaltır ve böylece birçok On-Chain işlemi yapmaya kıyasla ücretleri düşürür.
- Kanal kapatma:** Bir kullanıcı kanalını istediği zaman kapatabilir ve en son işlem durumunu yayınlayarak Bitcoin'sini geri alabilir. Bu, işlemlerin her an **"yayınlanabilir" ancak gerekli olana kadar "yayınlanamaz "** olması ilkesidir. Çıkış (kanal kapatma) tek taraflı (herhangi bir zamanda 2 taraftan herhangi biri tarafından kararlaştırılabilir) veya karşılıklı olarak kararlaştırılabilir (daha düşük On-Chain ücretleriyle sonuçlanır)

![BIZ101](assets/en/04.webp)

Bu yaklaşım, her işlemi doğrudan Bitcoin'in ana Blockchain'unda gerçekleştirmenin yavaşlığını ve karmaşıklığını önler, yalnızca nihai bakiyeleri kaydeder ve güvenliğini korur. Lightning Network, Bitcoin'in "üstünde" bir Layer'dir ancak ona bağlı kalır.
...
**Bitcoin'in Exchange Yeteneklerinin Artırılması:**

Lightning, Bitcoin'nin "Exchange aracı" olarak rolünü güçlendirir İşlemlerin sıklığını ve özgürlüğünü artırarak, paranın birincil işlevini güçlendirir: tüm katılımcılar için ekonomik alışverişleri ve değer yaratmayı kolaylaştırmak.

"Akıllı makine ekonomisinin" gelecekteki yükselişi, yalnızca Lightning'in karşılayabileceği bir teknik standart olan ultra hızlı, yüksek frekanslı bir ödeme sistemi gerektirecektir. Bu sayede daha fazla mal ve hizmet üretilebilecektir. Bitcoin'in Supply'u sınırlı kaldıkça, her bir birimin satın alma gücü artacaktır. Bitcoin ve Lightning, ağları genişledikçe birlikte güçlenir.
...
- Hız:** Lightning (~500 ms ila birkaç saniye), işlemlerin onaylanmasının yaklaşık 30 dakika sürebildiği Bitcoin ana ağından önemli ölçüde daha hızlıdır. Büyük alımlar için (1.000 doların üzerinde), hız daha az kritik olduğundan Bitcoin ana ağı hala tercih edilebilir. Ancak, uygulamalar bu kararları arka planda sorunsuz bir şekilde yerine getirdiğinden, bu ayrıntılar genellikle ortalama bir kullanıcıdan gizlenir.
...
- Ücretler:** Lightning Network üzerindeki işlem ücretleri minimum düzeydedir ve satıcı tarafından değil kullanıcı tarafından ödenir. Satıcılar yalnızca Bitcoin'larını daha sonra başka bir ağa veya hizmete aktarmaları gerektiğinde ücrete tabi olurlar.
...
Lightning Network'nin teknik işleyişi hakkında daha fazla bilgi için bu diğer kapsamlı kursu da takip etmenizi öneririm:
...
Fiyatlar ve rekabet gibi piyasa sinyalleri, işletmelere kaynak tahsisi konusunda akıllı kararlar almalarında rehberlik eder. Şirketler bu sinyallere kulak vererek kendilerini aşırı genişletme veya özellikle kolay kredi gibi yapay faktörlerden etkilenen kötü yatırımlar yapma tuzağından kaçınabilirler. Kaynakların yanlış tahsisi sadece şirketin sağlığını tehlikeye atmakla kalmaz, aynı zamanda müşterilere etkin bir şekilde hizmet verme kabiliyetini de azaltır.
...
Zamanını mızrağı inşa etmeye adarken, rezervlerine güveniyor ve acil rahatlığının bir kısmını isteyerek erteliyor (**zaman tercihinin** bir yansıması). Birkaç gün süren Hard çalışmasının ardından sağlam bir mızrağı tamamlar.
...
Avusturyacı görüşe göre sermaye, gelecekteki üretimi artıran araçlar veya üretken kaynaklar oluşturmak için tüketimin ertelenmesi fikriyle derinden bağlantılıdır. Sermaye birikimi olarak bilinen bu süreç, Avusturya ekonomi teorisinin merkezinde yer alır. Bu bakış açısının temel Elements'si şunlardır:
...
Böyle bir ortamda, girişimciler tarafından özenle biriktirilen "sağlıklı" sermaye, yapay olarak yaratılan "sağlıksız" sermaye ile nasıl rekabet edebilir? Dahası, Supply parasının tek taraflı olarak genişletilmesi, sağlam sermayenin satın alma gücünü aşındırarak ekonomik yönelim bozukluğunu ve toplumsal memnuniyetsizliği daha da kötüleştirmektedir.

**Bir Umut Işığı: Bitcoin**

Bitcoin, parasal enflasyonun neden olduğu erozyon olmaksızın uzun vadede sermaye biriktirmenin ve korumanın bir yolunu sunar. Bir değer deposu olarak, işletmelerin gelecekteki yatırımlarını esneklikle planlamalarını sağlayarak borç odaklı sistemlerin hakimiyetine meydan okur ve gerçek, üretken sermaye birikimine dönüşü teşvik eder.
...
## Bitcoin'nın hazinede tutulması
...
**Karşı taraf riskleri**: Mevcut finansal sistem risklidir ve "paranıza" her zaman erişiminiz olmayabilir İskambil kâğıtlarından bir ev imajını çağrıştırmadan, finansal kurumların en ufak bir krizde kârları özelleştirdiğini ve zararları toplumsallaştırdığını kabul etmek gerekir. "Kutsal" para sisteminde (Ledger'de kayıtlı para), bankadaki para yalnızca bir "hak talebidir"; ona gerçekten sahip değilsinizdir ve bankaların kendileri de "ona sahip değildir" (kısmi rezervler). Bu para bir bakıma gerçekten büyülüdür. Bir zamanlar Bitcoin ile alay eden Credit Suisse gibi bazı prestijli bankalar bugün artık mevcut değildir.

Bu güven eksikliği, altın gibi "hamiline" varlıkların (güvenliğini sağlamak, taşımak ve bölmek vb. karmaşık olsa da) ve tabii ki yeni gelen Bitcoin'ün yeniden canlanmasına yol açıyor.

### Finansal varlık olarak Bitcoin

Bitcoin radikal bir alternatif sunmaktadır. Merkezi bir ihraççısı olmayan **hamiline yazılı bir varlıktır**, ele geçirilmesi neredeyse imkansızdır ve ağ etkilerinden faydalanır. "Gerçek" Bitcoin kullanıcıları, hem sansüre hem de enflasyona karşı dayanıklı bir değer deposu olarak görüldüğünden, emeklerinin meyvelerini saklamak için onu kullanmayı tercih etmektedir. Metcalfe Yasası ile gösterilen ağ etkisi sayesinde, ikna edilen her yeni kullanıcı ağın değerini artırır; katılımcı sayısı arttıkça Bitcoin'in faydası katlanarak artar. Bu model, Bitcoin'i kullanıcı benimsemesi ve güven üzerine inşa edilmiş, kendine özgü ve gelecek vaat eden bir sermaye biçimi haline getirmektedir.

Bitcoin, kapanış saatleri ve "devre kesicileri" olan geleneksel finans piyasalarının aksine, 7/24 kesintisiz çalışan **dünyadaki en fazla Liquid varlığıdır** Bu likidite, kullanıcıların iyi ya da kötü haberlere (örneğin füze fırlatılması, savaşlar vb.) yanıt olarak her an bitcoin alıp satmasına olanak tanır.
...
İlk olarak, **geçmiş performans gelecekteki sonuçları garanti etmez**. Bitcoin **güvenli ve merkeziyetsiz** kaldığı sürece, önümüzdeki on yıl boyunca yıllık fiyatının %20'nin çok üzerinde bir artış göstermesi ve bu sayede uygulanabilir bir hazine aracı haline gelmesi makul olarak beklenebilir.

İkincisi, Bitcoin şimdiye kadar **4 yıllık döngüler** yaşamıştır, yani 4 yıldan fazla bir zaman ufkuyla bahis her zaman kârlı olmuştur. Bitcoin'yi bir yatırım olarak görenler için kısa vadeli bir ufuk (<4 yıl) riskli olabilir.
...
| Ticker | 1D Akış (M USD) | 1W Akış (M USD) | 1M Akış (M USD) | 3M Akış (M USD) | YTD Akış (M USD) |

| ------- | --------------- | --------------- | --------------- | --------------- | ---------------- |

| **Toplam** | +457,19 | +1.507,95 | +2.888,01 | +3.672,29 | **+20.262,94** |
...
Bitcoin'ün Amerika Birleşik Devletleri'nde giderek daha fazla benimsenmesi, dünyanın başka yerlerindeki zihniyetleri de etkiliyor; özellikle de geleneksel finansal ürünler düşük performans gösterirken ya da zor dönemlerden geçerken, bunu araç yelpazelerine dahil etmemeyi artık göze alamayan varlık yönetimi profesyonelleri arasında. Sadece geleneksel bankalar hala bunu görmezden gelmeyi göze alabiliyor gibi görünüyor.

Tamamen finansal bir perspektiften bakıldığında, Bitcoin bir çeşitlendirme varlığı olarak kabul edilmektedir. Sadece diğer varlık sınıflarıyla korelasyonsuz olmakla kalmayıp, aynı zamanda yeni likidite enjeksiyonları dönemlerinde de gelişiyor gibi görünmektedir - böyle bir dönem ECB, Fed ve Çin tarafından faiz oranlarının düşürülmesiyle başlıyor gibi görünmektedir.
...
Örneğin, diğer kullanım durumları Bitcoin'yı stratejik bir hazine varlığı haline getirmektedir:
...
Tam olarak 1 Bitcoin satın almak zorunda değilsiniz, çünkü Bitcoin, anonim yaratıcısının onuruna satoshis adı verilen alt birimlere bölünebilir. Bir Bitcoin **100 milyon satoshiye** eşittir ve kullanıcıların bir Bitcoin'un **çok küçük kesirlerini** bile satın almasına, satmasına veya takas etmesine olanak tanır. Aslında, Bitcoin'un kaynak kodunda, tüm işlemler satoshi olarak muhasebeleştirilir ve "Bitcoin" terimi yalnızca madencilerin ödüllerini almak için oluşturdukları özel işlem olan "coinbase "de görünür.

Dahası, toplam 21 milyon bitcoin - ya da **2,1 katrilyon satoshi** - 64 bitlik bir tamsayı ile verimli bir şekilde temsil edilebilir. Bu da bütün Bitcoin başına yüksek bir fiyat olmasına rağmen, bölünebilirliği sayesinde geniş bir yatırımcı kitlesi için erişilebilir olduğu anlamına gelmektedir. Dolayısıyla, ağa katılmak veya bu dijital varlığa yatırım yapmak için bütün bir Bitcoin satın almanıza gerek yoktur.
...
Bitcoin'ye yatırım yapmak için **karar verme süreci** şirket içindeki konumunuzdan büyük ölçüde etkilenecektir. Eğer bir **çoğunluk sahibi iseniz, fazla hazine fonlarını kendi kararınıza göre tahsis etmekte özgürsünüz**. Buna karşılık, kolektif bir karar alma yapısı içinde bir ortak veya hissedar iseniz, ortak müzakerelerden geçmeniz gerekecektir, bu da işleri karmaşıklaştırabilir.

Bu ikinci senaryoda, büyük ölçüde **her bir paydaşın Bitcoin varlığına ilişkin anlayışına** bağlı olduğundan, farklı bakış açılarının uyumlaştırılması elzem hale gelmektedir. Söylendiği gibi: "Bitcoin, insanların bilgisayarlar hakkında bilmedikleri her şey ile para hakkında anlamadıkları her şeyin birleşimidir." Ortaklardan biri Bitcoin'ü iyice anlamak için çaba sarf etmiş olsa bile, bu bilgiyi diğerlerine aktarmak zor olabilir. Bu gibi durumlarda, fikrin bir kişiyle çok yakından özdeşleşmesini önlemek için dışarıdan bir kaynak getirilmesi **tavsiye edilir**, bu da generate direncine neden olabilir.

Şu anda, çoğunluk sahibinin karar vermesi senaryosu, Bitcoin'i elinde bulunduran şirketler arasında en çok temsil edilen senaryodur. İşte birkaç gerçek örnek :


- Bağımsız profesyoneller**: Uzun vadeli hazinelerinin bir kısmını Bitcoin'ya yatıran danışmanlar, sağlık pratisyenleri veya avukatlar. Genellikle bu profesyoneller zaten yetersiz getirili tasarruf veya vadeli mevduat hesaplarına sahiptir.
- Teknoloji sektörü yöneticileri**: Birkaç yıl önce şirketini satan ve kişisel holdinginden elde ettiği gelirin bir kısmını Bitcoin'ye yatıran bir yönetici. Bugün rahat bir mali duruma sahipler ve yeni girişimlere yeniden yatırım yapıyorlar.
...
- MicroStrategy gibi halka açık şirketler** kurumsal hazinelerinin önemli bir kısmını Bitcoin'a dönüştürerek emsal teşkil etmiş ve kurumsal sermaye tahsis stratejilerinde küresel bir değişim olduğunu göstermiştir. 2024 sonbaharında, çok sayıda başka şirket de bu eğilimi takip ederek daha da meşrulaştırdı.
...
Bu farklılıklar nedeniyle, **bazı işletme sahipleri Bitcoin'ü kurumsal yapıları** üzerinden satın almayı ve elde tutmayı tercih etmektedir, zira bunu yapmak **daha verimli vergi planlama fırsatları** sağlayabilir. Her zaman olduğu gibi, uyumluluğu sağlamak ve vergi stratejisini optimize etmek için ilgili yargı alan(lar)ındaki kurallara aşina bir vergi uzmanına danışılması tavsiye edilir.
...
Bitcoin'i edinmenin üç yolu vardır:

![BIZ101](assets/en/09.webp)


- Mal veya hizmetler için Exchange'da:**

Bitcoin, Exchange'nin bir aracı olarak işlev gördüğünden, döngüsel bir ekonomi öngörmek mümkündür. Günümüzde bu durum yaygın olmasa da, giderek daha fazla işletme Bitcoin ödemelerini kabul etmeye başlıyor - sizinki neden olmasın? (Bir sonraki bölümümüze bakınız)


- Mining Bitcoin:**

Bu, Mining makinelerinin çalıştırılmasından ödül kazanmayı içerir. Uzmanlaşmamış işletmeler için bu nispeten marjinal kalmaktadır. Size bilgisayar, ağ ve bakım satacak veya kiralayacak aracılar vasıtasıyla katılabilirsiniz. Makinelere sahipseniz, bunları amortismana tabi varlıklar olarak muhasebeleştirebilirsiniz. Büyük ölçekte, yatırım getirisini dikkatli bir şekilde hesaplamanız gerekecektir çünkü pazar oldukça rekabetçidir ve başta elektrik olmak üzere maliyetlerin iyi tahmin edilmesini gerektirir.
...
Daha önce de belirtildiği gibi, Bitcoin'nin gelecekteki fiyatını tahmin etmek imkansız olduğu gibi, fiyat kısa vadede de çok değişkendir. Tarihsel olarak, güvenilir bir strateji düzenli aralıklarla kademeli olarak birikim yapmak ve dört yıl veya daha uzun bir zaman ufkunu korumak olmuştur.
...
Gayrimenkul sektörü sık sık "satın almak için her zaman doğru zaman" ifadesini tekrarlarken, gayrimenkulün değer saklama işlevini yitirmesi halinde (Bitcoin gibi varlıklara geçiş) fiyatların kullanım değerine (barınak) yaklaşabileceğini unutmaktadır. Buna karşın Bitcoin, değer depolamaktan başka bir amaca hizmet etmiyor, bu da "satın almak için her zaman doğru zaman" anlamına gelebilir Bunu gelecek gösterecek.
...
Örneğin, Fransa'da Paymium (Exchange) veya BullBitcoin (broker) gibi platformlar, dümende gerçek Bitcoin meraklılarına sahip olmaları ve sağlam bir sicil oluşturmalarıyla bilinir. ABD'de River veya Swann gibi hizmet sağlayıcılarınız var. Genel olarak, sağlayıcının soyağacını incelemek önemlidir: itibarları, geçmiş performansları, Bitcoin topluluğu içindeki popülerlikleri ve liderliklerinin Bitcoin'ın temel değerleriyle uyumlu olup olmadığı.
...
- Saklama ve Güvenlik:** Platform bitcoinleri sizin adınıza mı tutuyor yoksa Ownership'ü size mi aktarıyor? Güvenlik kurulumları nedir? "Para çekme kilitleri" veya diğer para çekme sınırlamaları var mı?
...
## Bitcoin'nin ödeme olarak alınması

<chapterId>99af1203-bc84-4acc-9780-f733e7998335</chapterId>

Öncelikle, Bitcoin'in internet ile aynı ölçekte bir yıkım olduğunu anlamak önemlidir.
...
Bitcoin, ilk uygulaması aracıları değer-paranın depolanmasından ve Exchange'dan kaldırmak olan bir güven altyapısıdır. Şu anda hayal bile edilemeyen diğer uygulamalar bu altyapı üzerinde ortaya çıkacaktır. Buradaki ilk varlığınız bir web sitesine sahip olmakla eşdeğerdir: eşler arası ödemeler ve değer değişimleri için bir ağ geçidi.
...
Ödemelerinizi Bitcoin formunda tutmanız gerekmez-özellikle tedarikçilere ödeme yapmanız veya KDV havale etmeniz gerekiyorsa. Bazı hizmetler, Bitcoin ödemelerinizin tamamını veya bir kısmını bir ücret karşılığında seçtiğiniz para birimine (örneğin, IBAN'ınıza Euro) dönüştürebilir. Bu senaryoda, Bitcoin'u kabul etmenin yararı, yeni kullanıcıları çekmek veya Bitcoin'un kendine özgü avantajlarında (daha düşük ücretler, günün her saati çalışma ve dolandırıcılık veya ters ibraz riski olmaması gibi) yatabilir.
...
Bir tüccar olarak zihniyetiniz de önemlidir. Basit bir test mi yapıyorsunuz yoksa Bitcoin'nin önemli ve yinelenen bir gelir kaynağı olmasını mı bekliyorsunuz? Eğer ikincisi ise, sağlam, kapsamlı ve özelleştirilebilir bir kuruluma ihtiyacınız olacaktır.
...
| **State of Mind** | "ilk fiziksel ödememi denemek", "çevrimiçi içeriğim için bahşiş almak", "çok küçük bir gelir hedeflemek" |

| **İşlem Sıklığı** | "öğrenmek için ilk işlem", "arada bir ödeme almak"                                                                    |

| **İş Türü Örnekleri** | Yaratıcı ekonomi (içerik oluşturucular, bloglar, makaleler, vb.), ara sıra ipuçları, tek seferlik yüz yüze ürün satışları, dernekler, tek seferlik etkinlikler |

| **Ödeme Türü** | Genellikle birkaç sent ila birkaç avro/dolar; ürün başına ~300 avro/dolar altında |

| **Ayarlar Karmaşıklığı** | Yok |

| **Örnek Önerilen Çözüm** | Satoshi'ün Wallet'ü gibi gözetimli bir Yıldırım Wallet veya Phoenix gibi gözetimsiz bir Wallet |

| **Merchant Interface** | Simple Bitcoin Lightning Wallet: cep telefonunda bir uygulama |

| **Müşteri Interface** | Bitcoin QR ödeme kodu, müşterinin kişisel Wallet'si aracılığıyla taranır |

| **Ücretler** | Müşteri Bitcoin Lightning ücretleri artı geçerli uygulama ücretlerini öder |

| **Satış Noktası Cihazı** | Ücretsiz akıllı telefon uygulaması veya fiziksel bir terminal seçeneği (örn. Bitcoinize) |

| **Yönetim ve Roller** | Tek uygulama yönetimi; minimum rol farklılaşması |

| **Muhasebe İhracatları** | Temel işlem geçmişi listeleri |
...
| **State of Mind** | "Bitcoin'yi işimde kabul ediyorum ancak anlamlı bir hacim beklemiyorum" |

| **İşlem Sıklığı** | Ayda birkaç işlem |

| **İş Türü Örnekleri** | Barlar, restoranlar, taze veya doğrudan tedarik edilen ürünlerin yarı düzenli satışı, tek bir sahip altında birden fazla mağaza, sanatçılar için yaratıcı ekonomi |

| **Ödeme Türü** | Genellikle ürün başına birkaç avro/dolar ile birkaç yüz arasında değişir; ürün başına ~300'ün altında ve aylık ~3.000'in altında |

| **Ayarlar Karmaşıklığı** | Minimal (mobil uygulama) |

| **Örnek Önerilen Çözüm** | İsviçre Bitcoin Ödeme |

| **Merchant Interface** | Simple Bitcoin Lightning Wallet: cep telefonunda bir uygulama; minimum ayrıntı ile basit faturalama |

| **Müşteri Interface** | Bitcoin QR ödeme kodu, müşterinin kişisel Wallet'u aracılığıyla taranır |

| **Fees** | Bitcoin Address'a göndermek için genellikle <%1 ve fiat'a dönüştürmek için <%1,5

| **Satış Noktası Cihazı** | Ücretsiz akıllı telefon uygulaması veya fiziksel bir terminal seçeneği (örn. Bitcoinize) |

| **Yönetim ve Roller** | Çalışanlar için sadece satış rolü seçeneği; yönetim için çevrimiçi gösterge paneli |

| **Muhasebe Dışa Aktarımları** | Tüm işlem ayrıntılarını içeren CSV dışa aktarımı |
...
| **State of Mind** | - E-ticaretim için diğerleri gibi bir ödeme yöntemi - Veya daha yüksek hacimlere hazır bir grup işletme için ortak yönetim |

| **İşlem Sıklığı** | Günde birden fazla işlem |

| **İş Türü Örnekleri** | Orta hacimli e-ticaret siteleri, küçük pazar yerleri, fiziksel mağaza grupları (örneğin, Tıkla ve Topla), KOBİ operasyonları |

| **Ödeme Türü** | Genellikle birkaç avro/dolar ile birkaç yüz arasında değişir; belirli bir ödeme büyüklüğü sınırı yoktur; yılda 250.000'den az |

| **Ayarlar Karmaşıklığı** | Hafif ila tam özellikli (yerel veya bulut barındırma), genellikle bir e-ticaret vitrini gerektirir |

| **Örnek Önerilen Çözüm** | E-ticaret ve/veya fiziksel ortamlar için BTC Pay Server; ödeme için ZapRite, Musqet veya PayWithFlash, entegre bir e-mağaza için Be-BOP |

| **Merchant Interface** | Invoice düzenleme, alışveriş sepeti seçenekleri ve ödeme düğmesi oluşturma özellikli web sitesi (mobil ve masaüstü); e-ticaret entegrasyonu ile otomatik faturalama |

| **Müşteri Interface** | Bitcoin QR ödeme kodu, müşterinin kişisel Wallet'sı aracılığıyla taranır |

| **Ücretler** | Ücretsiz açık kaynak arka uç ve ücretli Lightning barındırma/hizmet ücretlerinin karışımı; ön uç ücretleri Bitcoin Lightning ücretlerini ve <%1,5 dönüşüm ücretlerini içerir |

| **Satış Noktası Cihazı** | Web sitesi mağazası, isteğe bağlı fiziksel ekran (örneğin, siteyi gösteren iPad veya Bitcoin terminali) |

| **Yönetim ve Roller** | Birden fazla yönetici rolüne sahip tam özellikli mağaza; çalışanlar ve müşteriler sistemle etkileşime girer |
...
| **State of Mind** | - İşletme için stratejik bir ödeme yöntemi - Belirli spesifikasyonlara göre hizmet platformuna entegre etmek için bazı geliştirmelerle birlikte |

| **İşlem Sıklığı** | Sınırsız, yüksek frekanslı işlemler |

| **İş Türü Örnekleri** | Orta ölçekli işletmeler, BT hizmet şirketleri, büyük şirketler, büyük pazar yerleri |

| **Ödeme Türü** | Herhangi bir boyut veya hacim |

| **Ayarlar Karmaşıklığı** | Orta ila yüksek, mimari seçimine bağlı olarak |

| **Örnek Önerilen Çözüm** | Potansiyel olarak üçüncü taraf LSP (*Lightning Service Provider*) hizmetlerini kullanarak SaaS tarafından barındırılan çözümlerin özel yapım mimarisi veya orkestrasyonu |

| **Merchant Interface** | İşletmenin iş akışlarına ve süreçlerine tamamen entegre edilmiş, tamamen özelleştirilmiş ön uç ve arka uç arayüzleri |

| **Müşteri Interface** | Bitcoin QR ödeme kodundan tamamen özel bir kullanıcı arayüzüne ve/veya API entegrasyonuna kadar

| **Ücretler** | Dahili geliştirme ve üçüncü taraf ücretlerinin kombinasyonu; müşteri Bitcoin Lightning ücretleri artı hizmet sağlayıcılardan alınan işlem ücretlerini öder |

| **Satış Noktası Cihazı** | Kurumsal ortama uyarlanmış özel tasarım çözümler |

| **Yönetim ve Roller** | Satış, yönetim, devops, muhasebe ve finans alanlarında tamamen özelleştirilmiş roller |

| **Muhasebe İhracatı** | Tamamen özelleştirilmiş muhasebe ihracatı |
...
Başlangıç profili, önemli kaynaklar veya uzmanlık gerektirmeden Bitcoin ödemelerini keşfetmek isteyen işletmeler, içerik oluşturucular ve bireyler için tasarlanmıştır. Bunlar genellikle çok küçük hacimli işlemlerle (belki birkaç bahşiş, bağış veya ara sıra satış) ilgilenen ve Bitcoin ve Lightning Network ekosistemine basit, hafif bir giriş yapmak isteyen kişilerdir. Başlangıç yaklaşımının temel değeri, minimal kurulumunda yatmaktadır: çoğu durumda gereken tek şey, Lightning uyumlu temel bir Wallet ile donatılmış bir akıllı telefon veya tablettir.

![BIZ101-profiles](assets/en/18.webp)

Bu profilin belirleyici özelliklerinden biri, ayda nadiren birkaç yüz avro veya doları aşan düşük hacimli ödemelere odaklanmasıdır. Bu mütevazı ölçek, daha yüksek hacimli dağıtımların doğasında bulunan karmaşıklıklar olmadan Bitcoin ile pazarı test etmek isteyen herkes için mükemmel bir seçimdir. Ayrıca, anında uygulamalı öğrenmeye olanak tanır; daha az operasyonel baskı ve daha küçük parasal riskler olduğundan, hatalar kontrol altına alınabilir ve dersler hızlı bir şekilde öğrenilir. Hafta sonu fuarlarında el yapımı ürünler satan sanatçılardan tek seferlik bağış kabul eden kar amacı gütmeyen gruplara kadar bu kategorideki kullanıcılar genellikle gelişmiş işlevlerden ziyade erişilebilirlik ve kullanım kolaylığını vurgulamaktadır.

Starter profili için en yaygın iki Wallet kurulumu, gözetimli ve gözetimsiz çözümler arasında karar vermeyi içerir. Saklama amaçlı bir Wallet (Satoshi'in Wallet'u veya Blink gibi), üçüncü taraf bir hizmetin özel anahtarları ve arka uç işlemlerini yönetmesine olanak tanıyarak kullanıcının teknik sorumluluklarını azaltır. Bu düzenleme, özellikle her şeyden önce rahatlığa önem veren ve mümkün olan en basit ilk katılımı isteyen kişiler için caziptir. Öte yandan, gözetim altında olmayan Lightning cüzdanları (Phoenix veya Breez gibi) özel anahtarları ve tam kontrolü işletme sahibinin ellerine bırakarak, biraz daha fazla başlangıç çabası karşılığında Exchange'de daha fazla özerklik ve gizlilik sunar. Her iki durumda da, modern arayüzler genellikle o kadar kullanıcı dostudur ki, herkes temel görevleri (QR kodu oluşturma, ödeme tutarı girme ve işlemleri onaylama) birkaç dakika içinde halledebilir.

![BIZ101-profiles](assets/en/19.webp)

İşlemler küçük olduğunda güvenlik endişeleri daha az acil görünse de, yine de temel koruyucu önlemlerin alınması çok önemlidir. Bitcoin ödemelerini almak için kullanılan tek bir akıllı telefon veya tablet bile bir şifre veya biyometrik güvenlik ile kilitlenmeli ve yedekleme prosedürleri (gözetim altındaki bir Wallet için oturum açma kimlik bilgilerini takip etmekten, gözetim altında olmayan bir seed ifadesini korumaya kadar) ciddiye alınmalıdır. Fiziksel bir ortamda işlem yapan personelin temel bilgileri bilmesi faydalı olacaktır: uygulamanın nasıl açılacağı, müşteriye QR kodunun nasıl sunulacağı ve ödemenin gerçekten gelip gelmediğinin nasıl kontrol edileceği.

Muhasebe ve raporlama, Starter profili altında nispeten basit olsa da, yine de dikkatli bir değerlendirme gerektirir. İşlem hacimleri asgari düzeyde olsa da, doğru kayıtların tutulması ileride karışıklığı önler ve mali denetimler veya vergi beyannameleri durumunda şeffaflığın korunmasına yardımcı olur. Birçok Wallet uygulaması, kullanıcıların temel bir işlem geçmişini CSV dosyası olarak dışa aktarmasına olanak tanır; küçük bir işletme veya tek bir girişimci için bu dosyaları düzenli olarak kaydetmek, hesapların mutabakatını çok daha kolay hale getirebilir. Her bir işlemin alındığı andaki yaklaşık fiat değerini (örneğin avro veya dolar cinsinden) takip etmek de akıllıca olacaktır. Bitcoin'ün fiyatı dalgalanabildiğinden, dönüşüm oranlarının kaydını tutmak defter tutma ve vergi uyumu için çok değerlidir.

![BIZ101-profiles](assets/en/20.webp)

Fiziksel veya yüz yüze ödemelerini çevrimiçi bağışlar veya bahşişlerle desteklemek isteyen işletmeler için, bir Lightning bahşiş düğmesini veya bağış widget'ını bir web sitesine veya bloga entegre etmek artık çok kolay. BTCPay Server gibi platformlar yapılandırması kolay ödeme düğmeleri sunarken, bazı sosyal medya ve canlı yayın hizmetleri adresli Lightning bahşişlerini zaten desteklemektedir. Sonuç olarak, bir Starter kuruluşu bile mütevazı ama küresel bir müşteri ağı oluşturabilir. Bu arada, Bitcoin'yı uzun süre elinde tutmak istemeyenler, belirli saklama cüzdanlarını veya üçüncü taraf hizmetlerini kullanarak kısmi veya otomatik olarak itibari para birimine dönüştürmeyi keşfedebilirler. Bu seçenek ek ücretler ve olası KYC yükümlülükleri içerse de, işletmelerin Exchange kur oynaklığından kaçınmalarına ve mevcut finansal iş akışlarını en az kesintiyle sürdürmelerine yardımcı olur.

Basit bir kullanım örneği, tüm bu Elements'nin nasıl bir araya geldiğini göstermektedir. Bir Cumartesi çiftçi pazarında ev yapımı reçeller satan yerel bir zanaatkâr düşünün. Elinde Wallet gözetimli Lightning çalıştıran bir telefonla, her bir kavanozun fiyatını Euro olarak belirliyor; bir müşteri Bitcoin ile ödeme yapmak istediğinde, tüccar hızlı bir şekilde ilgili fiat tutarını giriyor ve uygulama otomatik olarak ödenmesi gereken Sats'i hesaplıyor. Ortaya çıkan QR kodu müşterinin Wallet'ı tarafından taranır, ödeme saniyeler içinde gerçekleştirilir ve zanaatkar işlemin başarılı olduğunu anında anlar. Günün sonunda, tüm işlem detayları kayıt tutmak için dışa aktarılabilir ve günün bakiyesi tamamen veya kısmen fiat para birimine dönüştürülmek üzere bir Exchange platformuna gönderilebilir.
...
**Kendi kendine emanet LN cüzdanları/nodları:**
...
Ödemeler Bitcoin olarak belirli bir Address'e çekilebilir veya fiat para birimine dönüştürülebilir ve günlük olarak bir banka hesabına yatırılabilir. Swiss Bitcoin Pay, Bitcoin ve Lightning Network ödemelerini manuel müdahale olmadan gerçekleştirerek süreci otomatikleştirir. Fonlar transferden önce en fazla 24 saat tutulmaktadır. BTCPay Server gibi tamamen gözetimsiz olmasa da, kolaylık ve güvenliği dengeler ve KYC gerektirmez.

![BIZ101-profiles](assets/en/22.webp)

Ücretler rekabetçidir: ilk yıl için %0,21, daha sonra Bitcoin ödemeleri için %1 ve Bitcoin işlem maliyetleri dahil olmak üzere fiat dönüşüm ödemeleri için %1,5. Swiss Bitcoin Pay, Open Node gibi saklama çözümleri ile BTCPay Server gibi karmaşık kendi kendine barındırılan sistemler arasında pratik bir orta yol sunarak basitlik, güvenlik ve finansal özerkliğe öncelik verir.

Bu tür bir kurulum, yüz yüze işletmelerin generate faturalarını hızlı bir şekilde ödemelerini, QR kodlarını müşterilerine sunmalarını ve Lightning veya On-Chain işlemlerini minimum sürtünme ile kabul etmelerini sağlar. Personelin bu ödemeleri gerçekleştirmek için yalnızca kısa bir oryantasyona ihtiyacı vardır; yöneticiler ise günlük satışların mutabakatını yapmak ve temel raporlara erişmek için çevrimiçi bir kontrol panelinde oturum açabilir. Kolaylaştırılmış bir yönetim konsolunun mevcudiyeti, daha küçük işletmelerin tek bir Interface'ten hem fiat hem de kripto gelirlerini takip etmelerine yardımcı olarak karışıklığı azaltır ve manuel defter tutma için harcanan zamanı azaltır.

![BIZ101-profiles](assets/en/23.webp)

Essential yaklaşımının bir diğer önemli avantajı da hızlı kurulum ve minimum kesintiye verdiği önemdir. Swiss Bitcoin Pay gibi çözümler günler veya haftalar yerine birkaç saat içinde kurulabilir. Örneğin, mütevazı derecede yoğun bir restoranın sahibi veya yöneticisi için nihai hedef, kasada gecikmelere veya personel arasında karışıklığa neden olmadan Bitcoin kabulünü entegre etmektir. POS yapılandırıldıktan sonra, yönetici çalışanlara Invoice'i gösterme ve ödemenin yapıldığını doğrulama konusunda hızlı talimatlar verebilir. En iyi senaryoda, bir müşterinin işlemi Lightning Network aracılığıyla neredeyse anında onaylanır ve işletmenin yönetim paneli aynı anda yeni bir ödemeyi gerçek zamanlı olarak kaydeder.

Essential profili son derece sofistike muhasebe sistemleri gerektirmese de, yine de uygun işlem kayıtlarını tutmak akıllıca olacaktır. Swiss Bitcoin Pay gibi araçlar CSV dışa aktarma işlevleri sunarak yöneticilerin her bir Bitcoin satışının fiat eşdeğeri değerini yakalamasını ve diğer gelir kaynaklarıyla birlikte takip etmesini sağlar. Bu düzeyde bir dokümantasyon çoğu küçük işletme için yeterlidir ve Exchange oranlarının temel düzeyde anlaşılması vergi beyannamesi ve genel mali gözetim konusunda yardımcı olacaktır.
...
Teknoloji ve araçlarla ilgili olarak, **BTC Pay Server** gibi çözümler genellikle Profesyonel bir kurulumun çekirdeğini oluşturur. BTC Pay Server, şirket içinde veya bulut barındırma yoluyla dağıtılabilen ve web siteleri ve e-ticaret platformları için kapsamlı entegrasyon seçenekleri sunan açık kaynaklı bir platformdur. İşletmeler kendi örneklerini çalıştırarak, otomatik olarak oluşturulan ödeme sayfalarından ödeme onaylandıktan sonra dahili süreçleri tetikleyen bildirimlere kadar ödeme akışının her yönü üzerinde yüksek derecede kontrol sahibi olurlar.
...
Kurumsal profil, Bitcoin ödeme uygulamalarının zirvesinde yer alır ve özellikle büyük şirketler, büyük pazar yerleri ve tamamen özelleştirilmiş çözümler talep eden yerleşik işletmeler için uyarlanmıştır. Daha küçük ölçekli veya orta düzey dağıtımların aksine, Kurumsal düzeydeki operasyonlar Bitcoin ödemelerini, yerinde satış noktası cihazlarından e-ticaret vitrinlerine, arka ofis muhasebe platformlarına ve sofistike ERP çerçevelerine kadar geniş bir iş akışı ve sistemler ağına entegre eder.

Bu ölçekte, genel amaç sadece Bitcoin'ü kabul etmek değil, bunu kuruluşun temel süreçleriyle tamamen **hizalanmış** bir şekilde yapmaktır. Bu uyum, ister çözüm tamamen ısmarlama olsun ister üçüncü taraf *Yıldırım Hizmet Sağlayıcıları* (LSP'ler) tarafından desteklenen SaaS tabanlı bir altyapı aracılığıyla düzenlensin, özel yazılım geliştirme gerektirebilir. Bu tür LSP'ler, daha geleneksel kullanıma hazır araçların kapasitesini aşan yüksek işlem hacimlerini ve karmaşık ağ yapılandırmalarını idare edebilir. Bu nedenle ortaya çıkan mimari, API odaklı entegrasyonlardan gelişmiş hazine yönetimi yeteneklerine kadar çok çeşitli teknik ve ticari hususları içermektedir.
...
Her çözüm kategorisi için her zaman ödünleşimler vardır. Örneğin, ilk "deneme aşamasında", önerilen cüzdanlar kullanıcı Interface açısından mümkün olduğunca basit olacak şekilde tasarlanmıştır, ancak barındırılmaktadır (**custodial**). Bu da fonların uygulama sağlayıcısı tarafından kontrol edildiği anlamına gelmektedir. Bununla birlikte, Bitcoin'in ethosu, kullanıcı tarafından fonların tam Ownership'sine doğru ilerlemeyi teşvik eder (**self-custodial**). Bu durumda, ilk satışlar yapılır yapılmaz, yani Bitcoin'de ödeme yapmaya istekli müşterileriniz olduğu doğrulandıktan sonra bir sonraki kategoriye geçmeniz önerilir.

Bitcoin'un en önemli avantajlarından biri, fonları dilediğiniz gibi hareket ettirebilmenizdir; bu da sağlayıcıları** veya çözümünüzün bileşenlerini değiştirmeyi **çok kolay hale getirir. Ayrıca, tüm uygulamalar ve çözümler hızla gelişmektedir. Örneğin, sadece birkaç ay önce var olmayan bir çözüm olan ve şu anda piyasadaki birçok uygulama ile entegre olan fiziksel bir Satış Noktası (POS) terminali sağlayan Bitcoinize'ı düşünün.
...
- Basit Çözümler:** Alternatif olarak, bunu kendiniz yapmak için Accessing.app gibi platformları kullanabilirsiniz. Temel faydalar şunları içerir:
    ...
    - Kendi SwissBitcoinPay hesabınız üzerinden Bitcoin ödeme işlemleri.
...
- Geliştirilmiş Düğüm ve Kanal Yönetimi:** Hem bireysel hem de profesyonel çözümler gelişti. Örneğin, BTC Pay Server artık diğer sağlayıcılarla (PSP'ler, açma/kapama rampaları, vb.) bağlantı kurmak için çok sayıda eklentiyi desteklemektedir. LightSpark ve Alby Hub gibi yeni altyapı sağlayıcıları da üretime giriyor.
- Satıcı Benimseme Artışı:** BitRefill gibi satıcılar, aktif kullanıcıları arasında Bitcoin ödemelerinde bir artış olduğunu ve Lightning yerine Bitcoin'e doğru net bir geçiş olduğunu bildiriyor. Ayrıca, Lightning'in ultra düşük ücretleri, onu küçük ödemeler için tercih edilen seçenek haline getiriyor (işlem başına ortalama 32 €).
...
- Ağlar Arasında Köprü Olarak Lightning:** Lightning Network'nin verimliliği ve kullanılabilirliği, onu halihazırda diğer birbirine bağlı ağlara (ör. FediMint, Liquid, vb.) bir köprü olarak konumlandırmıştır.

**Wallet'un Geri Dönüşü**

Bitcoin ve Lightning Network **dijital Wallet devrimini** tamamlıyor. Yeni web hizmetleri artık **hesap oluşturmaya gerek kalmadan** işlem yapmaya izin veriyor - Wallet'niz kimliğiniz haline geliyor! Nostr Wallet Connect (NWC)** ve **LN-URL-AUTH** gibi protokollerle, cüzdanlar kullanıcıların kimliklerini sorunsuz bir şekilde doğrulayabilir ve geleneksel hesaplar olmadan işlemleri etkinleştirebilir. Basit satın alımlar veya abonelikler için hesap yorgunluğu günleri geride kaldı. Son olayların bize sık sık hatırlattığı gibi, hacklenebilecek ve dark web'de satılabilecek kişisel veya ödeme bilgilerini sağlamaya artık gerek yok.
...
Akılda tutulması gereken **en önemli sonuç**, çoğu yargı alanında Bitcoin'un kazanılması, satılması, ticaretinin yapılması veya alım yapmak için kullanılmasının genellikle **vergiye tabi bir olay** yaratması ve kazançların sermaye kazancı vergisine tabi olmasıdır.
...
Bitcoin sahibi işletmeler için muhasebe biraz zahmetlidir çünkü gerçekleşen veya gerçekleşmeyen kar veya zararları hesaplamak için her işlemin titizlikle takip edilmesi gerekir. Bitcoin'ü bir ödeme şekli olarak kabul ederek yaptığınız her satış için veya Bitcoin'ü her satın aldığınızda veya sattığınızda kaydetmeniz gerekir:


- belirli bir zaman
- satış fiyatı (fiat para birimi cinsinden)
- gW-335 maliyet fiyatı (Bitcoin'in ilk satın alındığı fiyat).
...
- Elde edilen Bitcoin'nın zamanını, fiat maliyet fiyatını ve miktarını kaydettiniz
- Satılan Bitcoin'nin zamanını, fiat satış fiyatını ve miktarını kaydettik
...
Bu işlem her işlem için tekrarlanmalıdır ve Bitcoin'ın fiyatının dalgalı yapısı kayıt tutmayı daha da külfetli hale getirmektedir.

**Bitcoin Bir Para Birimi Olsaydı Nasıl Çalışırdı?

Bitcoin bir para birimi olarak değerlendirilseydi, işletmeler bunu muhasebe sistemlerindeki diğer para birimleri gibi yönetirdi. Her bir işlem için maliyet esası ve gerçekleşen/gerçekleşmeyen karları takip etmek yerine, Bitcoin varlıkları basitçe bir para birimi hesabına kaydedilecektir. Her raporlama döneminin sonunda, Bitcoin de dahil olmak üzere tüm döviz varlıklarının değeri, geçerli Exchange kuru kullanılarak muhasebe para birimine (örneğin USD veya EUR) dönüştürülecektir.

**Bitcoin'ün para birimi olarak tanınması durumunda güncellenmiş örnek:**
...
**Bitcoin'in para birimi olarak tanınması halinde Anahtar Avantajı:**
...
- Bu, işlem düzeyinde maliyet bazlı izleme ihtiyacını ortadan kaldırır ve özellikle sık Bitcoin işlemleri yapan işletmeler için muhasebeyi basitleştirir.

Bu yaklaşım Bitcoin muhasebesini çok daha basit hale getirecek, idari yükleri azaltacak ve Bitcoin'in yasal ve düzenleyici açıdan tam olarak tanınması durumunda diğer para birimlerinin muamelesiyle uyumlu hale gelecektir. Henüz o noktada değiliz.

### Bireysel ve Kurumsal Bitcoin Muhasebesi Arasındaki Farklar

Bitcoin'ün yasal ve muhasebesel muamelesi bireyler ve şirketler arasında önemli farklılıklar göstermektedir. Bireyler için Bitcoin işlemlerinden elde edilen kazançlar, genellikle daha yüksek bir oranda olmak üzere gelir vergisine tabi olabilir. Buna karşılık, şirketler potansiyel olarak daha düşük kurumlar vergisi oranlarından faydalanabilir ancak daha katı defter tutma standartlarına uymak zorundadır.
...
Bitcoin'un yasal olarak tanınması ve muamelesi yargı yetkisine göre değişmektedir. El Salvador gibi bazı ülkeler Bitcoin'u yasal ödeme aracı olarak kabul ederek işlemlerde kullanımını kolaylaştırmış ancak uluslararası finansal raporlamayı zorlaştırmıştır. Diğerleri ise Bitcoin'u belirli vergi ve muhasebe kurallarına tabi bir dijital varlık olarak değerlendirmektedir.

Çoğu ülkede, Bitcoin dijital bir varlık olarak kategorize edilir ve muamelesi genel muhasebe standartlarına tabidir. İşletmeler Bitcoin işlemlerini aşağıdaki şekilde muhasebeleştirmelidir:
...
- Amerika Birleşik Devletleri:** IRS, Bitcoin'ü hisse senedi, tahvil veya gayrimenkule benzer şekilde **mülk** olarak sınıflandırmaktadır. Bu sınıflandırma, kripto para birimini içeren kazanç, satış, ticaret ve hatta satın almak için kullanmak gibi herhangi bir işlemin vergilendirilebilir bir olay yaratabileceği ve kazançların sermaye kazancı vergisine tabi olduğu anlamına gelir.
- Avrupa Birliği:** Üye devletler genellikle Bitcoin'ü işlevsel bir para biriminden ziyade spekülatif bir varlık olarak değerlendirmektedir. Bu nedenle kazançlar genellikle sermaye kazancı vergisine tabidir.
...
Kripto para inovasyonunun hızlı temposu genellikle düzenleyici çerçeveleri geride bırakmaktadır. Bitcoin'nın dijital bir varlık olarak tanınmasından bu yana, küresel düzenlemelerde kademeli güncellemeler yapıldı, ancak boşluklar devam ediyor:
...
### Bitcoin'un Finansal Tablolarda Sınıflandırılması

Bitcoin'in finansal tablolardaki sınıflandırması yargı yetkisine göre değişir ve bir işletme içindeki kullanım amacına bağlıdır. Genel olarak, Bitcoin envanter, yatırım veya para birimine benzer, ancak muhasebe işlemini etkileyen benzersiz özelliklere sahip bir dijital varlık olarak ele alınır.
...
- Envanter**: Bir işletmenin ana faaliyeti, kripto para borsaları veya brokerlar gibi Bitcoin ticaretini içeriyorsa, Bitcoin envanter olarak sınıflandırılır. Bu durumda, değerleme envanter muhasebesi standartlarını takip eder.
- Finansal Yatırım**: Bitcoin'ü uzun vadeli bir varlık olarak tutan şirketler bunu bir finansal yatırım olarak sınıflandırabilir. Örneğin, Amerika Birleşik Devletleri'nde işletmeler Bitcoin'ü Finansal Muhasebe Standartları Kurulu (FASB) yönergelerine göre muhasebeleştirebilir ve piyasa değerleri düştüğünde değer düşüklüklerini muhasebeleştirebilir.
...
Değerleme yöntemleri, işlemler sırasında kazanç veya kayıpların doğru bir şekilde hesaplanması için gerekli olan Bitcoin'ün maliyet esasını belirlemek için kullanılan muhasebe teknikleridir. Genel olarak, en iyisi **muhasebe sisteminde mevcut Bitcoin varlıklarının maliyetlerinin** her zaman güncellenen bir değerini tutmaktır. Bu, şeffaflığı ve vergi düzenlemelerine uyumu sağlar ve hesaplamaların yapılması gerektiğinde geride kalmayı önler.


- İlk Giren İlk Çıkar (FIFO)**: Avustralya ve Hindistan gibi ülkelerde yaygın olan bu yöntem, Bitcoin'i en erken edinim maliyetine göre değerlemektedir. Bir satış gerçekleştiğinde Bitcoin'in her bir fraksiyonunun ayrı ayrı takip edilmesi gerekebileceğinden bu yöntem oldukça **karmaşık** hale gelebilir.
...
Doğru ve düzenli kayıt tutmayı sağlamak için bir şirketin Bitcoin satın almaya veya ödeme olarak kabul etmeye başladığı andan itibaren **Bitcoin maliyetlerini izleyen ayrıntılı bir çalışma kitabının tutulması şiddetle tavsiye edilir. Bitcoin ödemesini kabul etmek veya Bitcoin satın almak için bir yazılım çözümü seçerken yalnızca bu husus bile akılda tutulmalıdır.

### Perakende ve E-ticaret işlemlerinin muhasebeleştirilmesi

Perakendeciler her işlem için Bitcoin'den Exchange'ye oranını kaydetmelidir. Örneğin, birçok ülkede işletmeler KDV'yi hesaplamak için satış anında Exchange oranını kullanmaktadır.

İşletmeler, kullandıkları **Ödeme** araçlarının aşağıdakileri sağlayabildiğinden emin olmalıdır:


- generate yerel fiat tutarı (euro, dolar, pound), KDV veya diğer yerel vergiler, Bitcoin cinsinden eşdeğeri, tarih ve saat, Bitcoin Exchange oranı ve Exchange kaynağı vb. içeren bir Invoice
...
- Volatilite**: Bitcoin'ün fiyatı önemli ölçüde dalgalanır, bu da holdingleri değerlemede ve gelecekteki finansal sonuçları tahmin etmede zorluklar yaratır.
- Düzenleyici İnceleme**: Çin gibi ülkelerde Bitcoin'in kısıtlı statüsü hazine varlığı olarak kullanımını sınırlamaktadır.
- Mevzuat Belirsizliği** : Bitcoin'nın değişen düzenleyici ortamı genellikle işletmeleri belirsizlik içinde bırakır. Örneğin, Hindistan veya Amerika Birleşik Devletleri'nde olduğu gibi vergi politikalarındaki değişiklikler muhasebe uygulamalarını bir gecede etkileyebilir.
...
- Requalification Riskleri**: Bir şirketin hazinesinin önemli bir kısmının Bitcoin'de tutulması, işletmeyi fiyat düşüşlerinden kaynaklanan potansiyel kayıplara maruz bırakır. Bu durum, özellikle bu tür düşüşlerin tedarikçilere, çalışanlara veya vergilere yapılacak ödemelerin vadesi geldiğinde meydana gelmesi halinde ciddi sonuçlar doğurabilir. Ayrıca, şirket sahibi sorumlu tutulabilir ve bu da para cezalarına veya şirket varlıklarının kötüye kullanılması suçlamaları gibi diğer yasal sorunlara yol açabilir.

## Muhasebe Araçları ve Yazılımları

<chapterId>e7b31be5-1176-4835-944e-3cba1b7040fa</chapterId>

Bir şirket Bitcoin'u muhasebesine entegre etmeye karar verdiğinde, çeşitli araçlar ve özel yazılımlar verilerin toplanmasını ve işlenmesini basitleştirir. En iyi bilinen çözümler arasında [CoinTracker](https://www.cointracker.io/), [Waltio](https://www.waltio.com/), [Cryptio](https://cryptio.co/), [Koinly](https://koinly.io/), [TokenTax](https://tokentax.co/) ve [ZenLedger](https://zenledger.io/) bulunmaktadır. Bu platformlar öncelikle dört konuya odaklanmaktadır:
...
**Senaryo**: Küçük bir fırın Bitcoin'yi ödeme yöntemi olarak kabul eder ancak kripto para dalgalanmalarına maruz kalmamak için aldığı tüm Bitcoin'yi derhal avroya dönüştürür.
...
- Müşteriden gelen işlem**: Müşteri 50 € karşılığında hamur işi satın alır.
    ...
    - Bitcoin'de tutuldu (%50): 62.500 Satoshis = 0,000625 Bitcoin.
...
- Ücretler**: 0,375 €.
- Alınan Net Avro**: 24.625 Avro.
- Bitcoin Alıkonuldu**: 62,500 Satoshis.
...
### Kullanım Örneği 3: Uzun Vadeli Yatırım için Bitcoin'yı Elinde Tutan Profesyonel Hizmet

**Senaryo**: Serbest çalışan bir grafik tasarımcı ödeme olarak Bitcoin'yi kabul eder ve aldığı tüm Bitcoin'yi uzun vadeli bir yatırım olarak saklar.
...
- Bitcoin bilançosunda 3.500 Avro değerinde (0,1) tutmuştur.
- Gerçekleşmemiş kazançlar takip edilir ancak kar/zarar tablolarına dahil edilmez.

### Kullanım Örneği 4: İşletme Sahibi Fiyat Artışından Sonra Bitcoin'ün %50'sini Satıyor

**Senaryo**: Bir işletme sahibi yıl içinde üç Bitcoin satın alır, Bitcoin'i bir varlık olarak tutar ve önemli bir fiyat artışından sonra %50'sini satar.
...
- Bitcoin**'ün %50'sinin satışı:
    ...
    - Maliyet Esası (Ağırlıklı Ortalama):
        ...
        - Satılan Bitcoin'nin maliyeti: 0,19335 Bitcoin × 25.850 € = 4.999 €.
...
- Gerçekleşmemiş Kazanç**: Finansal notlarda açıklanan 5.468 Avro (kalan Bitcoin'un gerçekleşmemiş değeri dahil).

**Muhasebe Etkileri**:


- Satış hasılatını (7.734 €) gelir olarak kaydedin.
- Gerçekleşen kazancı hesaplamak için satılan Bitcoin'ın maliyetini (4.999 €) düşer.
